...
<head>
    ...
    <title>Vidéo YouTube - Histoire de l'Asie</title>
    <style>
        body {
...
<body>
    ...
    <section class="video">
        <h2>Vidéo : L'Histoire de l'Asie :  histoire des 3 royaumes </h2>
        <!-- Intégration de la vidéo YouTube -->
        <iframe src="https://www.youtube.com/watch?v=npMR1WLY_Nk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    </section>

    <footer>
        <p>&copy; 2025 Histoire de L'Asie Tous droits réservés.</p>
    </footer>
